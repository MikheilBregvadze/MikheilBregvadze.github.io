...
(function (pixi_spine) {
    ...
    (function (core) {
        ...
        var EventQueue = (function () {
            ...
            // დამატება Update
            EventQueue.prototype.update = function (entry) {
                this.objects.push(EventType.update);
                this.objects.push(entry);
            };
                ...
                for (var i = 0; i < objects.length; i += 2) {
                    ...
                    switch (type) {
                        ...
                        case EventType.update:
                            if (entry.listener != null && entry.listener.update)
                                entry.listener.update(entry);
                            for (var ii = 0; ii < listeners.length; ii++)
                                if (listeners[ii].update)
                                    listeners[ii].update(entry);
                            //var count = core.MathUtils.toInt(entry.loopsCount());
                            //entry.onUpdate && this.deprecateStuff() && entry.onUpdate(entry.trackIndex, count);
                            //this.animState.onUpdate && this.deprecateStuff() && this.animState.onUpdate(entry.trackIndex, count);
                            break;
        ...
        (function (EventType) {
            ...
            // დამატება Update
            EventType[EventType["update"] = 6] = "update";
        ...
        var AnimationStateAdapter2 = (function () {
            ...
            // დამატება Update
            AnimationStateAdapter2.prototype.update = function (entry) {
            };
    ...
    function imageLoaderAdapter(loader, namePrefix, baseUrl, imageOptions) {
        ...
        return function (line, callback) {
            ...
            if (cachedResource) {
                ...
                // დამატება
                if(typeof jetX !== 'undefined') {
                    jetX.resourceLoader.count += 1;
                } else if(typeof cricketX !== 'undefined') {
                    cricketX.resourceLoader.count += 1;
                } else if(typeof gameCanvas !== 'undefined') {
                    gameCanvas.resourceLoader.count += 1;
                }
